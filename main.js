...
const starts = async (client = new WAConnection()) => {
  ...
  client.browserDescription = ["Fann Bot", "Chrome", "3.0"];
  ...
  client.on("open", () => {
    success("2", "Connected, Welcome back Irfan:)");
  });
  ...
  client.on("group-participants-update", async (anu) => {
    try {
      ...
      if (anu.action == "add" && mem.includes(client.user.jid)) {
        ...
        kontakowner = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: `6288213840883-1616169743@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `Fann WhatsappBot`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Irfann,;;;\nFN:Irfann,\nitem1.TEL;waid=6281944991069:6281944991069\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./stik/thumb.jpeg')}}}
        waktu = moment.tz("Asia/Jakarta").format("HH:mm");
        teksny = `Halo Semuanya, Salam kenal👋\nNama saya: Irfan\nUmur: 17\nAsal: Kota Bekasi\n\nSalam kenal semuanya :)`
        client.sendMessage(mdata.id, teksny, MessageType.text, { quoted: kontakowner, thumbnail: fs.readFileSync('./stik/thumb.jpeg'), contextInfo: {forwardingScore: 508, isForwarded: true, externalAdReply:{
          title: `Bergabung Jam ${waktu}`,
          body:"",
          mediaType:"2",
          thumbnail: thumb, 
      ...
      if (anu.action == "add" && !mem.includes(client.user.jid)) {
        ...
        teks = `Halo @${num.split("@")[0]}\nSelamat datang di ${mdata.subject}\n\nNama:\nUmur:\nGender:\nAsal:\n\nSemoga Betah dan Following Rules Group`;
        ...
        imageMsg = (
          await client.prepareMessageMedia(buff, "imageMessage", {
            thumbnail: buff, contextInfo: {mentionedJid: [num]}
          })
        ).imageMessage;
        buttonsMessage = {
          contentText: `${teks}`,
          footerText: "Selamat datang dan Selamat berbelanja.",
      ...
      if (anu.action == "remove" && !mem.includes(client.user.jid)) {
        ...
        buttonsMessage = {
          contentText: `${out}`,
          footerText: "Terimakasih sudah mengunjungi, Pulsanya sekalian kak >-<",
          imageMessage: imageMsg,
          buttons: buttons,
          headerType: 4,
        };
      ...
      if (anu.action == "promote") {
        ...
        teks = `Selamat @${num.split("@")[0]} !\nAnda telah di Promote sebagai admin dari Groub:\n${mdata.subject}`;
        fkontaks = { 
          key: {
          fromMe: false,
participant: `0@s.whatsapp.net`, ...(anu.jid ? { 
 ...
 message: {
    "contactMessage":{"displayName":`${anu_user}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\n
    N:2;${anu_user};;;\n
    FN:${anu_user}\nitem1.TEL;
    waid=6281944991069:6281944991069\nitem1.X-ABLabel:Mobile\nEND:VCARD`,
     "jpegThumbnail": `${ppimg}`}}}
        client.sendMessage(mdata.id, buffer, MessageType.image, {
          quoted: fkontaks, caption: teks, contextInfo: {mentionedJid: [num]}
        });
      }
